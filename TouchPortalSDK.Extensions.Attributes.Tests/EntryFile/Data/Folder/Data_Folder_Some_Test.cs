...
namespace TouchPortalSDK.Extensions.Reflection.Tests.EntryFile.Data.Folder
{
    [Plugin]
    public class Data_Folder_Some_Test
    {
        ...
        public void Action([Attributes.Data.Folder(Id = "dataId", Label = "Data Label", Default = "string")]string value)
        {
            //
        }
        ...
        {
            Assert.AreEqual("folder", _data["type"]);
        }
