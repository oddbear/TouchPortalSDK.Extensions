...
{
    [Plugin]
    public class Data_Switch_Some_Test
    {
        ...
        public void Action([Attributes.Data.Switch(Id = "dataId", Label = "Data Label", Default = true)]string value)
        {
            //
        }
        ...
        {
            Assert.AreEqual(true, _data["default"]);
        }
