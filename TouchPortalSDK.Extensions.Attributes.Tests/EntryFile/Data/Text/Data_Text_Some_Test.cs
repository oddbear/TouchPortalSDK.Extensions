...
{
    [Plugin]
    public class Data_Text_Some_Test
    {
        ...
        public void Action([Attributes.Data.Text(Id = "dataId", Label = "Data Label", Default = "string")]string value)
        {
            //
        }
        ...
        {
            Assert.AreEqual("text", _data["type"]);
        }
